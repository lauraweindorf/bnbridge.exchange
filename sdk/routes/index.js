...
router.post('/api/v1/createAccountBNB', bodyParser.json(), models.createAccountSCRT);
router.post('/api/v1/downloadKeystoreBNB', bodyParser.json(), models.downloadKeystoreSCRT);
